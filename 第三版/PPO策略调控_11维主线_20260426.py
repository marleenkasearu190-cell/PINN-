...
def build_observation_dataframe(
    ...
    forcing_columns = ['Date', 'doy_sin', 'doy_cos', 'T_air_C', 'wind_speed_m_per_s', 'Solar_W_m2', 'LST_surface_C']
    ...
    for epoch in range(epochs):
        ...
        if epoch % 200 == 0 or epoch == epochs - 1:
            print(
                ...
                f"adv={losses['loss_vertical_exchange'].item():.4f} | conv={losses['loss_convective_mixing'].item():.4f} | mix={losses['loss_surface_mixed_layer_uniformity'].item():.4f} | drop={losses['loss_abrupt_surface_cooling'].item():.4f} | overturn={losses['loss_autumn_overturn'].item():.4f} | heat={losses['loss_heat_budget'].item():.4f} | "
