...
python lake_profile_scorecard.py ^
  --truth "data\\mohonk\\profile_truth.csv" ^
  --pred "outputs\\run7\\temperature_depth_predictions.csv" ^
  --label "run7" ^
  --pred "outputs\\11d_run1\\temperature_depth_predictions.csv" ^
  --label "11d_run1" ^
  --out-dir "outputs\\score_outputs"
"""
