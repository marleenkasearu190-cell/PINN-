...
本仓库不包含原始数据、训练 checkpoint 和大批量实验输出。运行训练或预测前，需要按 [`DATA.md`](./DATA.md) 准备 ERA5、LST 和剖面观测数据。公开复现流程见 [`REPRODUCE.md`](./REPRODUCE.md)；当前机器上的绝对路径可放在未提交的 `REPRODUCE_LOCAL.md` 中。
